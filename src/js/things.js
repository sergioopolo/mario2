...
function resetThings() {
  window.PlayerMyfix = true; //do not scale main char
...
function setPlayerSizeSmall(me) {
  setSize(me, 10, 10, true);
  updateSize(me);
  //console.log(me); 
}
function setPlayerSizeLarge(me) {
  setSize(me, 16, 16, true); //temp
  updateSize(me);
}
...
function simpleEnd(me) {
  ...
  setTimeout(function() { 
    var innerHTML = "<div class='congrat-gifs'><img src='Theme/ss.gif'><img src='Theme/eagle.gif'></div><div class='congrat-msg' style='font-size:36px;'>Pozdravlyaem!<br>Super Sergio blagodarit za violonchel!</div>";

    innerHTML += getSharingHTML();

    body.className = "simple-end"; // to make it black
    body.innerHTML = innerHTML;
...
function getSharingHTML(){
  var url = 'https://dossier.center/s-roldugin/ ',
      title = 'Поздравляем! Супер-Сержио благодарит вас за виолончель и деньги, которые будут перечислены в его офшоры.',
svg= '<svg xmlns="http://www.w3.org/2000/svg"><symbol id="icon-facebook" viewBox="0 0 15 32"><path d="M14.66 10.216H9.667V6.94c0-1.23.815-1.516 1.39-1.516h3.523V.019L9.727 0C4.341 0 3.115 4.032 3.115 6.612v3.604H0v5.57h3.115V31.55h6.552V15.786h4.421l.572-5.57z"></path></symbol><symbol id="icon-telegram" viewBox="0 0 32 27"><path d="M29.84.177L1.494 11.11c-1.935.777-1.923 1.856-.353 2.337l7.07 2.206 2.705 8.294c.329.907.166 1.267 1.12 1.267.735 0 1.061-.335 1.471-.735.26-.255 1.808-1.76 3.535-3.438l7.353 5.433c1.353.746 2.33.36 2.667-1.257L31.89 2.47c.494-1.981-.756-2.88-2.05-2.293zM9.32 15.147L25.255 5.092c.795-.482 1.525-.223.926.309l-13.644 12.31-.532 5.667-2.685-8.233z"></path></symbol><symbol id="icon-twitter" viewBox="0 0 32 26"><path d="M31.528 3.033a12.87 12.87 0 0 1-3.715 1.018A6.48 6.48 0 0 0 30.657.472a12.948 12.948 0 0 1-4.107 1.57 6.468 6.468 0 0 0-11.021 5.9A18.366 18.366 0 0 1 2.194 1.184a6.435 6.435 0 0 0-.875 3.252A6.465 6.465 0 0 0 4.197 9.82a6.45 6.45 0 0 1-2.93-.81v.082a6.473 6.473 0 0 0 5.189 6.343 6.503 6.503 0 0 1-2.922.11 6.475 6.475 0 0 0 6.042 4.492 12.976 12.976 0 0 1-8.033 2.77c-.522 0-1.037-.031-1.543-.091a18.304 18.304 0 0 0 9.916 2.906c11.898 0 18.403-9.856 18.403-18.404 0-.28-.005-.56-.018-.838a13.1 13.1 0 0 0 3.227-3.347z"></path></symbol><symbol id="icon-vk" viewBox="0 0 32 21"><path d="M.005 1.527c-.219-1.336 6.241-.509 6.241-.509s3.75 9.417 5.228 9.417c1.478 0 .766-7.985.766-7.985s-1.833-.478-1.833-1.21C10.407.51 12.24 0 12.24 0h5.393c.646 0 .903 1.05.903 1.75v8.558h1.478s1.316-2.115 2.354-4.263c1.038-2.149 2.3-5.027 2.3-5.027h6.267s1.15.032 1.013.986c-.186 1.299-4.356 7.466-5.228 9.576-.657 1.59 2.76 3.744 4.215 6.045.945 1.493 1.013 3.245 1.013 3.245h-7.445l-3.723-4.327s-.766-.318-1.368.127c-.603.446-.63 1.337-.63 1.337v2.863h-5.83s-4.461-1.527-8.239-8.208C.936 5.982.224 2.863.005 1.527z"></path></symbol></svg>',
sh = '<div id="sharing"><a class="telegram" rel="nofollow" href="tg://msg?text='+title+' '+url+'" target="_blank"><svg class="svg-icon icon-telegram"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-telegram"></use></svg></a><a class="facebook" rel="nofollow" href="https://www.facebook.com/sharer/sharer.php?u='+url+'" target="_blank"><svg class="svg-icon icon-facebook"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-facebook"></use></svg></a><a class="twitter" rel="nofollow" href="https://twitter.com/intent/tweet?url='+url+'&amp;text='+title+'" target="_blank"><svg class="svg-icon icon-twitter"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-twitter"></use></svg></a><a class="vk" rel="nofollow" href="https://vk.com/share.php?url='+url+'&amp;title='+title+'" target="_blank"><svg class="svg-icon icon-vk"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-vk"></use></svg></a></div>';
